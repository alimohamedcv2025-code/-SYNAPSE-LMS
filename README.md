...
### للإدارة والأكاديميين / For Admins & Faculty
...
| :----------------------------- | :---------: | :-------------: | :--------------: |
| تصفح المواد والكتب             |     نعم     |       نعم       | نعم (حسب مستواه) |
| طرح أسئلة واستفسارات           |     نعم     |       نعم       |        نعم       |
| الإجابة على أسئلة الطلاب       |     نعم     | نعم (ضمن نطاقه) |        لا        |
| إضافة/تعديل المواد الدراسية    |     نعم     | نعم (ضمن نطاقه) |        لا        |
| إدارة الحسابات والطلاب         |     نعم     |     عرض فقط     |        لا        |
| تعيين إداريين وتعديل الصلاحيات |     نعم     |        لا       |        لا        |
...
<div align="center">
  <sub>صُنِع بحب لتسهيل التجربة التعليمية والجامعية</sub>
</div>
